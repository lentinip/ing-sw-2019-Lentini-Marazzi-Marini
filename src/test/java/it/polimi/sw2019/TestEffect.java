...
public class TestEffect {
    ...
    public void allowedCellsTest() {
        ...
        Player player1 = new Player("Enzo", it.polimi.sw2019.commons.Character.BANSHEE);
        player1.setPosition(cell1);

        Player player2 = new Player("Carl", it.polimi.sw2019.commons.Character.DISTRUCTOR);
        player2.setPosition(cell3);

        Player player3 = new Player("Anna", it.polimi.sw2019.commons.Character.VIOLET);
        player3.setPosition(cell5);

        Player player4 = new Player("Luca", it.polimi.sw2019.commons.Character.DOZER);
        player4.setPosition(cell11);
